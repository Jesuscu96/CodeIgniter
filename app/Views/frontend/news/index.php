...
<head>
  ...
  <link href="<?= base_url('assets/dist/css/pricing.css') ?>" rel="stylesheet">
  <style>
    .bd-placeholder-img {
      font-size: 1.125rem;
      text-anchor: middle;
            ...
            <div class="col">
              <div class="card mb-4 rounded-3 shadow-sm">
                <div class="card-header py-3">
                  <h4 class="my-0 fw-normal"><?= esc($news_item['title']) ?></h4>
                </div>
                <div class="card-body">
                  <a href="<?= base_url('frontend/news/' . $news_item['slug']) ?>" class="w-100 btn btn-lg btn-outline-primary">View article</a>
