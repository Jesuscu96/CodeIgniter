          ...
          <div class="table-responsive small">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="<?= base_url('news/'.$news_item['slug']) ?>" class="btn btn-outline-primary">View article</a></td>
                <td><a href="<?= base_url('news/del/'.$news_item['id']) ?>" class="btn btn-outline-secondary">Delete Noticia</a></td>
                <td><a href="<?= base_url('news/update/' . $news_item['id']) ?>" class="btn btn-outline-success">Edit Noticia</a></td>
