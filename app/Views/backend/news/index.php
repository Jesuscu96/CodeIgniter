                ...
                <?php foreach ($categories_list as $category_item) : ?>
                  <li class="nav-item">
                    <a
                      ...
                      aria-current="page"
                      href="<?= base_url('backend/newsByCategory/' . $category_item['id']) ?>"
                      >
              ...
              <?php if ($news_list !== []): ?>
                <?php foreach ($news_list as $news_item): ?>
                  <tr>
                    ...
                    <td><a href="<?= base_url('backend/news/' . $news_item['slug']) ?>" class="btn btn-outline-primary">View article</a></td>
                    <td><a href="<?= base_url('backend/news/del/' . $news_item['id']) ?>" class="btn btn-outline-danger">Delete Noticia</a></td>
                    <td><a href="<?= base_url('backend/news/update/' . $news_item['id']) ?>" class="btn btn-outline-success">Edit Noticia</a></td>
