...
use App\Controllers\NewsControllerFrontend;
...
//Frontend
$routes->get('/', [NewsControllerFrontend::class, 'index']);
$routes->get('news', [NewsControllerFrontend::class, 'index']);
$routes->get('frontend/news/(:segment)', [NewsControllerFrontend::class, 'show']);
...
$routes->group('backend', function($routes){
    ...
    $routes->get('newsByCategory/(:num)', [NewsController::class, 'newsByCategory']);
